...
python batch_request_openAI.py \
  --requests_filepath requests_to_parallel_process_news.jsonl \
  --save_filepath requests_to_parallel_process_results_news.jsonl \
  --request_url https://api.openai.com/v1/completions \
  --api_key="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" \
  --max_requests_per_minute 20 \
  --max_tokens_per_minute 150000 \
...
python batch_request_openAI.py \
  --requests_filepath requests_to_parallel_process_news_full.jsonl \
  --save_filepath requests_to_parallel_process_results_news_full.jsonl \
  --request_url https://api.openai.com/v1/completions \
  --api_key="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" \
  --max_requests_per_minute 20 \
  --max_tokens_per_minute 150000 \
...
python batch_request_openAI.py \
  --requests_filepath requests_to_parallel_process_elonmusk.jsonl \
  --save_filepath requests_to_parallel_process_results_elonmusk.jsonl \
  --request_url https://api.openai.com/v1/completions \
  --api_key="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" \
  --max_requests_per_minute 20 \
  --max_tokens_per_minute 150000 \
  ...
  python batch_request_openAI.py \
  --requests_filepath requests_to_parallel_process_elonmusk_2023-04-15_100_p1.jsonl \
  --save_filepath parallel_process_results_elonmusk_2023-04-15_100_p1.jsonl \
  --request_url https://api.openai.com/v1/completions \
  --api_key="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" \
  --max_requests_per_minute 20 \
  --max_tokens_per_minute 150000 \
  ...
  python batch_request_openAI.py \
  --requests_filepath requests_to_parallel_process_iamsrk_2023-04-17_sentiment.jsonl \
  --save_filepath parallel_process_results_iamsrk_2023-04-17_sentiment.jsonl \
  --request_url https://api.openai.com/v1/completions \
  --api_key="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" \
  --max_requests_per_minute 20 \
  --max_tokens_per_minute 150000 \
  ...
  python batch_request_openAI.py \
  --requests_filepath requests_to_parallel_process_iamsrk_2023-04-17_p1.jsonl \
  --save_filepath parallel_process_results_iamsrk_2023-04-17_p1.jsonl \
  --request_url https://api.openai.com/v1/completions \
  --api_key="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" \
  --max_requests_per_minute 20 \
  --max_tokens_per_minute 150000 \
  ...
  python batch_request_openAI.py \
  --requests_filepath requests_to_parallel_process_elonmusk_2023-04-17_topic-classification.jsonl \
  --save_filepath parallel_process_results_elonmusk_2023-04-17_topic-classification.jsonl \
  --request_url https://api.openai.com/v1/completions \
  --api_key="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" \
  --max_requests_per_minute 20 \
  --max_tokens_per_minute 150000 \
  ...
  // new key
  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
...
def num_tokens_consumed_from_request(
    ...
    if api_endpoint == "completions":
        # print("Printing request_json prompt")
        # print(request_json["prompt"])
